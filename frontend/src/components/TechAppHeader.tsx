...
/**
 * Tech Panel Layout — wraps /tech/* routes.
 * Shows the full navigation: Home, Dataset, Train, Results, AutoPilot, Reports.
 */
...
const techNavItems = [
    { path: '/tech', label: 'Home', icon: 'home', exact: true },
    { path: '/tech/clean', label: 'Dataset', icon: 'table_chart' },
    { path: '/tech/train', label: 'Model', icon: 'model_training' },
    { path: '/tech/results', label: 'Results', icon: 'leaderboard' },
    { path: '/tech/autopilot', label: 'AutoPilot', icon: 'rocket_launch' },
    { path: '/tech/reports', label: 'Reports', icon: 'summarize' },
]

export function TechAppHeader({ onExport, rightSlot }: AppHeaderProps) {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md">
            <div className="flex items-center justify-between px-6 py-2.5">
                {/* Logo — click goes to panel selector */}
